(function (ns) {
    ...
    ns.GridOptions = function(options) {
        this._options = options || {};
    };

    ns.GridOptions.prototype = {
        getColumns: function () {
            return this._options.columns || [];
        },

        getEmptyDataText: function () {
            return this._options.emptyDataText;
        }
    };
    ...
    ns.Grid = function (gridOptions, dataSource, element) {
        ...
        this._gridOptions = new ns.GridOptions(gridOptions);
    ...
    ns.Grid.prototype = {
        _initElements: function () {       
            ...
            this._element.addClass('PlatformUI-Control PlatformUI-Grid');
        },

        _getColumns: function () {
            return this._gridOptions.getColumns();
        },
        ...
        _createHeaderCell: function (column) {
            ...
            if (!this._sortingEnabled || !column.dataColumn || !column.dataColumn.sortable) {
                ...
                var sortButton = $('<a href="javascript:void(0)"></a>');
                sortButton.append(headerText);
                sortButton.click(function() {
                    _this._sortButton_OnClick(column.dataColumn);
                });
        ...
        _sortButton_OnClick: function (dataColumn) {
        ...
        _createEmptyDataRow: function () {
            if (this._gridOptions.getColumns().length === 0)
                return;

            var emptyDataText = this._gridOptions.getEmptyDataText();
            if (!emptyDataText)
                return;

            var cellElement = $('<td></td>');
            cellElement.attr('colspan', this._gridOptions.getColumns().length);
